"""sp500_four_strat_port — v10: Five strategies, equal-vol + sector neutral.

Adds short-horizon sector-relative momentum (w20_s0_equal, Sharpe 1.25)
as a fifth sleeve to the v8 portfolio configuration.
"""
...
def main():
    ...
    print("\n[v10] Five strategies, equal-vol weighting + sector neutralization...")
    portfolio = (
        PortfolioStudy(
