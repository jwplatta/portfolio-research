"""sp500_four_strat_port — v9: v8 without the event-driven sleeve."""
...
from v0_equal_weight import (  # noqa: E402
    build_strategies_without_event_with_momentum_v29,
    load_benchmark,
    load_sector_factors,
    load_sector_map,
    load_universe,
...
def main():
    ...
    strategies = build_strategies_without_event_with_momentum_v29(sector_factors, sector_map)

    print("\n[v9] Equal-vol weighting + sector neutralization without event_driven_v26...")
    portfolio = (
        PortfolioStudy(
            strategies=strategies,
            universe=universe,
            benchmark=benchmark,
            name="sp500_four_strat_port_v9_sector_neutral_no_event_momentum_v29",
        )
