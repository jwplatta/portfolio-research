"""sp500_four_strat_port — v7: Equal-vol sleeve weighting with momentum_v29 replacing momentum_v19."""
...
def main():
    ...
    print("\n[v7] Equal-vol sleeve weighting with momentum_v29...")
    portfolio = (
        PortfolioStudy(
            strategies=strategies,
            universe=universe,
            benchmark=benchmark,
            name="sp500_four_strat_port_v7_equal_vol_momentum_v29",
        )
