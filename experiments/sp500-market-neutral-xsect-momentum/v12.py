"""v12 - custom rolling beta neutralization on top of v9."""
...
STUDY_NAME = "sp500_market_neutral_xsect_momentum_v12_beta_neutralized"
study = build_study(
    STUDY_NAME,
    ...
    liquidity_top_n=100,
    rebalance_every=10,
    risk_scalers=[beta_neutralize_positions(window=60)],
