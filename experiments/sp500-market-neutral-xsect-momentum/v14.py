"""v14 - market and sector neutralization on the v9 branch."""
...
STUDY_NAME = "sp500_market_neutral_xsect_momentum_v14_market_sector_neutral"
study = build_study(
    STUDY_NAME,
    ...
    signal_neutralization_factors=["market", "sector"],
