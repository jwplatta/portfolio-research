"""v30 - stability-adjusted residual momentum."""

from common import build_study, emit_metrics, residual_stability_signal

STUDY_NAME = "sp500_market_neutral_xsect_momentum_v30_residual_stability"
study = build_study(
    STUDY_NAME,
