"""v34 - volatility-based residual stability signal."""

from common import build_study, emit_metrics, residual_vol_adjusted_signal

STUDY_NAME = "sp500_market_neutral_xsect_momentum_v34_residual_vol_adjusted"
study = build_study(
    STUDY_NAME,
