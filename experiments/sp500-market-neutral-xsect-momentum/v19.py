"""v19 - residual momentum with 60-day lookback and 10-day skip."""

from common import build_study, emit_metrics, residual_momentum_signal

STUDY_NAME = "sp500_market_neutral_xsect_momentum_v19_residual_60_10"
study = build_study(
    STUDY_NAME,
    signal_fn=residual_momentum_signal(lookback=60, skip=10, shift=1),
    residualize=True,
    n_long=20,
    n_short=20,
