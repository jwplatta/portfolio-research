"""v23 - residual momentum with 90-day lookback and 20-day skip."""

from common import build_study, emit_metrics, residual_momentum_signal

STUDY_NAME = "sp500_market_neutral_xsect_momentum_v23_residual_90_20"
study = build_study(
    STUDY_NAME,
    signal_fn=residual_momentum_signal(lookback=90, skip=20, shift=1),
    residualize=True,
    n_long=20,
    n_short=20,
