"""v25 - residual momentum with 120-day lookback and 10-day skip."""

from common import build_study, emit_metrics, residual_momentum_signal

STUDY_NAME = "sp500_market_neutral_xsect_momentum_v25_residual_120_10"
study = build_study(
    STUDY_NAME,
    signal_fn=residual_momentum_signal(lookback=120, skip=10, shift=1),
    residualize=True,
    n_long=20,
    n_short=20,
