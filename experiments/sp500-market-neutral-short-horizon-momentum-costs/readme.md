# Sp500 Market Neutral Short Horizon Momentum Costs

Created with `qstudy create sp500-market-neutral-short-horizon-momentum-costs`.
...
2. Run `uv run qstudy iterate sp500-market-neutral-short-horizon-momentum-costs <version-name>` to create the next version file.
3. Run `python run.py` inside this directory.
4. Inspect `results.json` or use `qstudy show-results sp500-market-neutral-short-horizon-momentum-costs`.
