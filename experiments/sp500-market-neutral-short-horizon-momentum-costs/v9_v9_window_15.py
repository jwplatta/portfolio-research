"""v9: signal window = 15 days.

Shorter lookback decays faster — names exit/enter signal more quickly, potentially
increasing turnover. But it may improve signal freshness at the 5d rebalance cadence.
"""
...
def run_study() -> dict:
    ...
    study = (
        Study(universe=universe, benchmark=benchmark, name=study_name("v9_window_15"))
        .base_signal(short_horizon_sector_relative_signal(window=15, skip=0))
