...
def run_study() -> dict:
    ...
    study = (
        Study(
            ...
            benchmark=benchmark,
            factors=factors,
            name=study_name("v10_confirmation_filter"),
        )
        .residualize_returns()
        .base_signal(residual_mean_reversion_signal(window=5, shift=1, vol_window=20))
        ...
        .add_filter(short_term_confirmation_filter(fast_window=3, slow_window=5))
