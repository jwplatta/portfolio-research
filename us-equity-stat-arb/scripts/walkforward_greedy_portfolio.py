...
# Top seed candidates from find_seed_sleeves.py (always-active only, MIN_AVG_TURNOVER=0.005):
#   #1  avg_SR=1.05  neg_yrs=14%  "gap_accum_3d__r21__trend_20_100_off__cond__none"
#   #2  avg_SR=0.69  neg_yrs=22%  "dist_mr_k1_z20__r21__none__cond__none"
# - [x] 1. dist_mr_k1_z60__r5__none__cond__narrow_bull_off_40 — avg SR 1.44, min SR 0.54, 0 negative years
# - [x]  2. dist_mr_k1_z60__r5__none__cond__narrow_bull_off_50 — avg SR 1.40, min SR 0.47, 0 negative years
# - [ ]  3. dist_mr_k1_z60__r10__none__cond__narrow_bull_off_40 — avg SR 1.39, min SR 0.03, 0 negative years
...
SEED_SLEEVE: str | None = (
    ...
    # "dist_mr_k1_z60__r10__none__cond__narrow_bull_off_40"  # "dist_mr_k1_z60__r21__none__cond__none"
)
