...
I test six different signal families: momentum, active return mean reversion, residual return mean reversion, sector-relative mean reversion, distance-pairs mean reversion, and gap reversion \cite{Chan2009, Chan2013}. Table 1 gives the definitions and economic intuition behind each signal.
